...
export default async function RepoAnalysisDetail({
  params,
}: {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h1 className="text-2xl font-bold">Repo Analysis Detail</h1>
      ...
      <div className="bg-white p-4 rounded shadow space-y-3">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          ...
          <div>
            <span className="font-medium">Repo Created:</span>{" "}
            {a.repoCreatedAt ? new Date(a.repoCreatedAt).toLocaleString() : "-"}
          </div>
          <div>
            <span className="font-medium">Repo Updated:</span>{" "}
            {a.repoUpdatedAt ? new Date(a.repoUpdatedAt).toLocaleString() : "-"}
          </div>
          <div>
